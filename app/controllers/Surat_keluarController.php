...
class Surat_keluarController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				surat_keluar.id_perihal LIKE ? OR 
				surat_keluar.file_surat LIKE ?)";
			$search_params = array(
	...
	function view($rec_id = null, $value = null){
		...
		$fields = array( 
			...
			"surat_keluar.id_perihal", 
			"perihalsurat.perihal_name AS perihalsurat_perihal_name", 
		...
		$db->join("perihalsurat", "surat_keluar.id_perihal = perihalsurat.id_perihal", "INNER");  
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("tanggal_surat","Tujuan_surat","Nomor_surat","id_perihal");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("No_Agenda","tanggal_surat","Tujuan_surat","Nomor_surat","id_perihal","file_surat","tgl_entri");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'tanggal_surat' => 'required',
