...
$can_add = ACL::is_allowed("surat_keluar/add");
$can_edit = ACL::is_allowed("surat_keluar/edit");
$can_view = ACL::is_allowed("surat_keluar/view");
$can_delete = ACL::is_allowed("surat_keluar/delete");
?>
<?php
                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-Tujuan_surat">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['Tujuan_surat']; ?>" 
                                                data-pk="<?php echo $data['No_Agenda'] ?>" 
                                                data-url="<?php print_link("surat_keluar/editfield/" . urlencode($data['No_Agenda'])); ?>" 
                                    ...
                                    <tr  class="td-id_perihal">
                                        ...
                                        <td class="value">
                                            <a size="sm" class="btn btn-sm btn-primary page-modal" href="<?php print_link("perihalsurat/view/" . urlencode($data['id_perihal'])) ?>">
                                                <i class="fa fa-eye"></i> <?php echo $data['perihalsurat_perihal_name'] ?>
                                            </a>
                                        </td>
                                    </tr>
                                    ...
                                    <a class="dropdown-item export-link-btn" data-format="print" href="<?php print_link($export_print_link); ?>" target="_blank">
                                        ...
                                        <a class="dropdown-item export-link-btn" data-format="pdf" href="<?php print_link($export_pdf_link); ?>" target="_blank">
                                            ...
                                            <a class="dropdown-item export-link-btn" data-format="word" href="<?php print_link($export_word_link); ?>" target="_blank">
                                                ...
                                                <?php if($can_delete){ ?>
                                                <a class="btn btn-sm btn-danger record-delete-btn mx-1"  href="<?php print_link("surat_keluar/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
