					...
					<p>
						...
						<p class="adr clearfix">
							<span class="adr-group">
								<span class="street-address">Jl. Bhayangkara 1 No. 1 Kel. Pakujaya<br>
Kec. Serpong  Tangerang Selatan
 

</span><br>
								<span class="postal-code">15324</span><br>
								<span class="country-name">(Jakarta – Indonesia)</span>
							</span>
						</p>
					</p>
					<hr />
					<p>
						...
						<span class="editContent">+62 (21) 5312 8888 (Hunting)</span>
					</p>
					<hr />

					<p>
						<b class="chead"><span class="material-icons">email</span> Email</b><br />
						<a href="#" class="editContent">info@rajawaliparama.com</a>
					</p>
				</div>
			</div>
		</div>
